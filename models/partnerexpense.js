...
const PartnerExpenseSchema = new mongoose.Schema({
  partner: { type: String, required: true, index: true }, // Index added for faster search
...
export default mongoose.models.partnerExpense || mongoose.model("partnerExpense", PartnerExpenseSchema);